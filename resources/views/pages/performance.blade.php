...
@section('content')
    ...
    <section class="page-hero" id="pageHero">
        <div class="page-hero-bg active" style="background-image: url('https://agenda2063.africa/assets/news4.png');"></div>
        <div class="page-hero-bg" style="background-image: url('https://agenda2063.africa/assets/banner1.jpeg');"></div>
